...
# Bitcoin Knots 29.x LTS assembly spec
# Baseline: v29.3.knots20260508 (f41f01e1e6d); current: v29.3.knots20260717.lts
#   (c9c7b75b7e7), published as branch 29.x-knots-lts
#   in https://github.com/knots-dev/bitcoin
# Derived from knots-29.3.knots20260508.spec (luke-jr/tmp @ knots-spec), the
#   exact recipe that assembled the 29.3.knots20260508 release.
# Candidate backports are tracked in knots-next-29.spec (Luke's upstream spec), the
#   working spec for the next regular 29.x release.
# LTS policy: critical bug fixes and security fixes only; no new features,
#   no policy changes, no new PR backports beyond fixes.
# To cut an LTS point release: append fix lines to the appropriate section,
#   set a new timestamp, update the bump_version line near the end, then
#   reassemble with assemble-knots.pl and fast-forward 29.x-knots-lts.
...
# BUILD BUGS:
	...
	k309  -										ee4ebb35b4f	last=8c7a2f70d33 pdath/fix-arm-crypto-feature
		# LTS queue: cguida tACK x2 + kwsantiago ACK
...
# SYSLIBS:
	...
	5416  sys_libsecp256k1						6f196a7926b	last=0a4a73bb830 sys_libsecp256k1-30
	# TODO: sys_crc32c ??
	# Hopelessly diverged? -     sys_univalue					5a04090dfe1
	# Hopelessly diverged? 7485  sys_univalue_def				30111aa138c
	n/a   rm_minisketch-29+syslibs				c9a3fdebebf	last=0fd60441475 rm_minisketch-30+syslibs
		# Implicitly includes most of #18818
		#30.xTODO# sys_libminisketch
	15155 test_external_bcli					536cb427311	last=8f25a48c298 test_external_bcli-30
...
# TESTS:
	...
	-     lint_relaxer-29+knots					3313010ba20
	-     nowarn_unreachable-code				db436004d38
...
NM	-     ci_gha_makejobs_8						8d06fe9b489
	...
	k328  -										9ce121480b1	last=c198e9b3586 privkeyio/ci-test-each-commit-gui-deps
		# LTS queue: pdath ACK; needed for CI on the LTS branch
...
# FIXES:
	...
	32217 fix_gitdir_foreign					7461777a69f
		# Was part of #18902
	#30.xTODO# Revert #32220 (cmake: Get rid of undocumented BITCOIN_GENBUILD_NO_GIT environment variable)
	-     relsrc_embed_tagname-29+knots			59896f0dfed	last=607a4fddf61 relsrc_embed_tagname-30+knots
		# Was part of #18902
	18427 2020mingwthrd-mini					1daa32fdde1	 # Latest code now
	18490 bugfix_symcheck_pe_case				6181dfb1d24	last=63b637b3c34 bugfix_symcheck_pe_case-30
	14968 http_bind_error						b4dc31ec971	last=7b5e4001f9 laanwj/2018_12_http_bind_error
	-     http_bind_error+extra					a33d0496a43	last=33dcd1b043b http_bind_error+extra-30
	 ...
	 9524  rpc_pruneblkchain0					2f09f8ace19	last=88883ae13d
	10731 log_more_uacomment					854d6f90f0c
	29614 bufferedfile_fclose					203e58486ce
	14485 fadvise-29+knots						67bb891c143	last=8fe39e158f9 fadvise-30+knots
		# Was #12491
	# Needs review: 21313 fsync_dir_pt2 after PR submitted & reviewed & tested
	# Needs bugfix: -     fsync_dir_win
	-     rpcarg_type_per_name					822062b3d20
	-     fix_rpc_arg_multiname					2313e7e99ae
	-     bugfix_rpc_getbalance_hacky			2abcaae1149	last=d5ac1a2b0b1 bugfix_rpc_getbalance_hacky-30
	# FIX THE BELOW:
	...
	18194 bugfix_gui_edit_sendaddr-mini			4f8eddc0338	last=0a44e08992f bugfix_gui_edit_sendaddr
		# NOTE: -mini is just missing the last commit :)
	# Needs re-concept: 19358 # net: Make sure we do not override proxy settings in hidden service.
	19419 listwalletdir_skip_data				f112a05aebb	last=3f9cc0cd736 Saibato/wallet_351
	...
	g152  gui_notify_setup_bg					bb600d58e9f
	-     bugfix_gui_drop_abc_confusing_hack	d77fec672a4
	...
	g236  gui_init_walleterror_cont				656a5f978c8
	-     rpc_addconnection_mainnet				2b73adff875
	32343 subproc_closefds						3dbb5657c7c
		# Was #30756
		# Replaces #22417 (Boost::Process variant)
	# Needs review: 22665 darosior:rbf_optin_nomempool
	23027 bugfix_util_test_config				c76d976d07b
	...
	g506  qt_qrcode_sizefixes					ded39039d88
	# Needs review: 24034 -  # p2p: delete anchors.dat after trying to connect to that peers
	24066 -										a96b43995b7	last=89cb2b6d91e  # contrib/init: (OpenRC) use -daemonwait to wait for startup completion
	-     openrc_from_gentoo					41f6e37ced5
	...
	24479 bugfix_settings_numberval				11c52e16a05
	...
	24718 fix_rpc_docs_pr24718-28+knots			0df79cc3dda	last=68a041dd12b
	...
	g595  qt_handle_autostart_errors-0.15		526d20f8ac1	last=d932157eb79
		# Upstream mruddy-g/issue_24953 repo got deleted :/
	-   gui_psbt_error_msgbox					5cc1eb195e9	last=87c42be2d70 gui_psbt_error_msgbox-30
	...
	32358 fix_subprocess_pr32358-28				91154a239b3
	32567 fix_subprocess_pr32567-28				f9e94915b07	last=e63a7034f03 hebasto/250520-subprocess-backports
	29868 hww_windows-29						0c962d481e6	last=3a18075aedd hebasto/240414-win-subprocess
	...
	g633  -										4c97de8e29a	last=5fde8fbe085  # qt: Fix shortcut ambiguities
	# Meh: 25854 -  # tracing.md trivial English fixes
	g662  qt_fix_txview_202209					4dfac9b6d0e	last=7304c97b1af qt_fix_txview_202209-30
		# Includes gui#368
	...
	g677 fix_qt_peers_na						420cbbab627
	...
	g684  qt_reqs_multiselect_pr684-28+knots	06a1863a92a	last=a6f567590b7
	...
	-     qafix_assert_debug_log_create			2ec62620695
	-     acceptstalefeeestimates_mainnet_opt	a57d6da244d
	...
	27814 forbid_nohelp-29						74009b85b58	last=bfc2bb6a270
	...
	28029 fix_zmq_errhandling_202307-mini		e003e407073	last=ba28af94bd5 fix_zmq_errhandling_202307
		# Just diff-minimised
	28055 fix_getblockfrompeer_rereq_err		1d5dd86e6d1
	...
	28345 fix_bytespersigop_checks-mini			472a3e415e0	last=6f627727739 fix_bytespersigop_checks
	...
	28616 Sjors/2023/10/assume-unconfirmed		950011d5e33	last=3e281590c7d  # assumeutxo_unconfirmed_ux_Sjors-28
	(CHECK-LAST)	last=202163a6778 assumeutxo_unconfirmed_ux_Sjors-30
	-     assumeutxo_unconfirmed_ux-29			0d9974c449d	last=ee1bfd9dada assumeutxo_unconfirmed_ux-30
	-     qt_recomm_confirms-0.9				8cc626fd812
	...
	-     fix_keep_notmy_cookie					7347ed3f507	last=61678a031e1 fix_keep_notmy_cookie-30
	...
	29141 fix_rpcauth_blank						cc7c9c1ef3a
	...
	29175 -										f27917924f4	last=be8ae64b82e  # rpc: validate fee estimation mode case insensitive (fix_rpc_estmode_unset_case-24)
	...
	31551 bulk_block_rw-29+knots				8007e042aec
		# Optimisation, not fix - but simplifies #29307
	29307 AutoFile_error_check-29+knots			f08aa70110a	last=c10e382d2a3 vasild/AutoFile_error_check
	...
	29678 fix_init_lowdisk_warning_reqd-29		07e2511580d	last=b1117e5a716 fix_init_lowdisk_warning_reqd
	...
	-     jonatack/2024-05-fix-cjdns-detection-in-AddNode	b82dd5cc492	last=be4541abe59 jonatack/2024-05-fix-cjdns-detection-in-AddNode  # fix_cjdns_addnode_detect2-27+knots
	...
	31275 fix_rpc_example_quoting_pr31275-24	488611f2f90	last=7e93e292598
	...
	31514 fix_wallet_rpc_ranged_pr31514-29		6449486c799
	...
	31727 miniscript_nonfatal_pr31727-29		fd41b992744	last=3693e4d6ee0 !hodlinator/2025/04/31727_followup
	...
	31785 fix_gui_rpcconsole_waitfor-29			3b5b1ca4d1b
	...
	31958 -										87b4c260796	last=32dcec269bf  # rpc: add cli examples, update docs  # docfix_rpc_wallet_cf_psbt-24
	31979 -										d35645e09cf	last=f708498293c  # torcontrol: Limit reconnect timeout to max seconds and log delay in whole seconds  # tor_backoff_max-26
	# Needs review: 32051 jonatack/2025-03-addnode-p2p
	32073 netinactive_dont_downgrade-26			d12dfbeaf4e
	...
	32176 tor_rnd_stream_isolation-28			19341fc186b
		# Omitted renaming variable
	# Needs review: 32180 mzumsande/202403_ibd_lastcommonblock
	32185 fix_dbwrapper_batch_header_size-26	c3700f8fa5c
	...
	32351 qafix_nonrecurs_FindChallenges-28		48120118957
		# Fix only
	32355 fix_block_full_enough-29.3			1796de310a6
	# Needs review: 32367 hebasto/250428-enable-lang
	-     fix_fs_error_utf8-23					e74e4e5b2a7
		# Alternative to core#32383 hebasto/250429-fs-error
	32414 fix_reidxcs_periodic-25				5b98cca81eb	last=c1e554d3e58 andrewtoth/reindex-flush
		# Fix only
	...
	32539 fix_rpcallowip_cjdns-29				8da0a9eca4f	last=12ff4be9c72 pinheadmz/rpcallowip-rfc4193
	...
	# Needs review and simplification? 32636 davidgumberg/5-27-2025-create-refactor
		# + fix from #34490
	32682 fix_wallet_fillpsbt_nothrow-28		9135746bf5c
		# Diff-minimised only
	# Needs review: 32685 -  # wallet: Allow read-only database access for info and dump commands
	32736 fix_listwalletdir_err-23				d230a5d8ebc
	...
	32845 fix_rpc_nowallet_errors_pr32845-29	8df0e69f29a
	# Needs concept & review: 32869 instagibbs/2025-07-invalid-cb-stall
	32878 fix_index_rewind_badassert_pr32878-19	b222c6f68dd
		# Fix only; left off invasive test
	32987 fix_gui_reindex-29					2cbf25b7d64
...
TM	33105 cve2025_46598_pt1-29.1                            90b6537c971
TM	32473 cve2025_46598_pt2-29.1                            740ffbbf80d
TM	33050 cve2025_46598_pt3-29.1                            02aecfbd6e2
	...
	33311 log_quiet_pcp_unsupported-29			b65c367d5e8
	33338 pcp_interrupt-29						f01cc214c1a
		# Diff-minimised
	...
	g886  wrkrnd_qt_textedit_oom-0.14			9b991236542
	...
	33464 net_timers_for_inbound_inv-29			9c653c4e03e
NM	33475 fix_block_full_enough_underflow-29+k	652acad4d4c	last=b807dfcdc59 ismaelsadeeq/09-2025-miner-infinite-loop-fix
	33494 urlupd_depends_qrencode-28			b8f10568811	last=93a70a42d30 hebasto/250929-qrencode
	...
	33511 fix_sigint_waitrpcs-29				8dfd5ade8d6	last=c25a5e670b2 ryanofsky/pr/sigwait
	...
	33698 fix_qa_rpctimeout_pr33698-27			bb87045224e
	# Needs review: 33699 0xB10C/2025-10-addr-token-bucket-start-5
	n/a   restore_dnsseed_luke-jr-29.3			97d3ba29c3b
		# Reverts #33723
	...
	# IPC-specific: 33745 Sjors/2025/10/submit-solution-doc
		# +#33880
	g901 fix_qt_rpchistoryfilter_pr_g901-28		cf93d810ac2
	...
	33813 warn_for_rpcbind_ignored-29			e6d41188b23	last=335a05c69e1 Ataraxia009/rpc-bind-warning
	# Needs review: 33854 -  # fix assumevalid is ignored during reindex
	# MSVC-specific: 33865 hebasto/251112-plugin-path
	33956 fix_p2pv2_useafterfree_pr33956-26		9e5001ed273
	33960 loglevel_corrections-29+knots			1b29a907591
	...
	34224 fix_init_int_ec-27					72acd22b466
	34235 fix_miniminer_feeassert_pr34235-26	b696acdbcc4
	34252 doc_bips_add433-28					dc8e911c44d
	-     qt_scope_bringToFront_workaround-28	99070f46b77
	...
	34293 fix_vermsg_missing_comma-29+knots		4583717f052	last=ffd09f8a0d0 fix_vermsg_missing_comma
	34272 fix_psbt_bounds_assert_pr34272-25		aa02a749d4c
	# Needs followup work? 34281 maflcko/2601-build-fix-remove
		# 30.x backport in #34283
		# + #34413 (see also issue #34414)
		# + #34468 ?
	34282 qafix_win_log_skips_pr34282-24		84ab258e5a4
	# Duplicate of #29678: 34305 fanquake/fix_space_warning_log
		# Consider CeilDiv from #34436
	34328 monotonic_uptime-29					207ee8a28da	last=e67a676df9a !l0rinc/l0rinc/fix-uptime-first-call-zero
		# + #34437
	...
	34369 qa_timeout_factor_netshutdown-29		c98e49d0b1c
	...
	34470 leveldb_wrkrnd_uninit_debugsize-0.8	a8f11068b8c	last=fad7d86d8d1 maflcko/2602-ci-leveldb-ub
	...
	-     qt_dialogs_less_modal					70559dbbb34
	-     docfix_getorphantxs_vsize				357888fb6bf
		# Originally bundled in Knots with #30793 rpc_getorphantxs
	-     fix_guix_boost_mirror-29				729416d1862
	-     fix_qt_startup_unknown_unit			0b07af321f5
	-     fix_qt_psbtops_filename_amount		974fb8797c8
	...
	k298  -										fea8c726f9c	last=a560eda4b06 luke-jr/param_bounds_checks_202604
		# LTS queue: maintainer-authored bugfix, kwsantiago crACK
		# LTS follow-up 582024cc1e5: name AssignIntArgToVarOptions type in template
		# args (bare braced NTTP breaks Apple clang); reported upstream on knots#298
	k330  -										61c59187cbc	last=191d0fdc9e2 privkeyio/fix-netwatch-gui-thread-race
		# LTS queue: heap corruption fix, pdath tACK
	k331  -										00ae8a213fc	last=accba6a6f88 privkeyio/fix-rpcconsole-wallet-selector-sync
		# LTS queue: pdath ACK
	k329  -										c5851d796f4	last=49db8d133cf privkeyio/fix-gen-bitcoin-conf-datadir
		# LTS queue: pdath ACK
	# LTS queue (blocked): k332 privkeyio/fix-receiverequestdialog-translation-assert - pdath ACK, pending luke-jr nit
	# LTS watch (needs review): k317 FindMostWorkChain UB fix - kwsantiago review findings unresolved
	# LTS watch (needs review): k323 RDTS-inactive script cache fix - no qualifying human ACK yet
	# LTS watch (needs rebase): k291 checkpoint/assumevalid update - kwsantiago utACK, values verified vs synced nodes
...
# PERFORMANCE:
	...
	28430 -										a22da5e02bf	last=42b25bbd939  # opti_merkle_mutation-0.17
	28592 -										74893bdf645 last=b81f37031c8  # txrelayrate_14txps-26
	...
	29602 opti_IsSpace_pr29602-29+knots			0f7864a3dc1
	# TODO: Revert #29815 ? (ie, use OS provided optimised timingsafe_bcmp)
	30059 dbfilesize_param-29.1					a25819a2a14	last=c283a572145 dbfilesize_param
	-     dbfilesize_64-29.1+knots				0d7375a486e
	...
	30611 chainstate_write_hourly-29+knots		1f9b52e7bf9	last=e976bd30450 andrewtoth/write-chainstate-every-hour
	...
	31144 opti_multibyte_xor-29+knots			e896def01a0
	31179 -										5f073501bc6	last=5d82d92aff7  # opti_rpc_uv_reserve-25
	31645 opti_dbbatchsize_64-29				93da575c584	last=b6f8c48946c l0rinc/l0rinc/utxo-dump-batching
	...
	32279 opti_script_inline_36b-29				b04d9437481	last=d5104cfbaeb l0rinc/l0rinc/prevector-size
	32487 opti_readblock_hash_once-29			b6c5fd5b9c3
	-     netproc_check_blockhash				f1cc03ccc44
	...
	32827 opti_removeForBlock_empty-28			a91c456563b	last=249889bee6b l0rinc/l0rinc/empty-mempool-IBD
	...
	33332 opti_arith_uint256_trivialcopy-28		cd53f868fb3
	33334 opti_blkidx_comparator-26+knots		98d36d8f92a	last=80ac0467ef4 Raimo33/index-work-comparator-branchless
	33410 opti_coinstats_nocopy_pr33410-26		e1b1a99cf9f	last=85d058dc537  # coinstats: avoid unnecessary Coin copy in ApplyHash
	...
	33738 opti_cmpctblocks_nolog_skip_hash-29	32c98d1da8c	last=969c840db52 l0rinc/l0rinc/debug-log-serialization
		# Very partial
	...
	34025 cache_time_and_arg_pr34025-29			4b8336b5d83
	# Needs review: 34054 sedited/txdownloadman_ibd_check
	# Needs review: 34083 theuni/chacha20-vectorized-initial
	34253 lockless_isibd-26+knots				973277b65a0	last=557b41a38cc l0rinc/l0rinc/cache-ibd-status
...
# FUNCTIONALITY:
	...
	18479 rpc_sign_show_fees					891029b995b	last=47b2ba29df2 !origin-pull/12911/head
	...
	15836 fee_histogram+pr15836_api				590247f3f20	last=b94292a7cb jonasschnelli/2019/04/feeinfo
	...
	22693 getaddressinfo_txids					e9cdaaa74f9
	g562  wallet_warn_reuse_gui					3c77421e5df
		# NOTE: Was #15987
	...
	18972 neutrino_whitelist-mini				bdddcb46bb8	last=a0d0807abc2 neutrino_whitelist
		# NOTE: Diff-minimised
	# Needs work/review AND CONCEPT ACK: 17950 emilengler:2020-01-password-strength-checker
	-     qt_openuri_pastebtn_shortcut-23		577fba1abcf
	...
	18014 siphash_optimise_pr18014-27+knots		223dd641a2d	last=409c2e34522 elichai/2020-01-siphash
	...
	24202 rpc_dumptxoutset_hr-29+knots			937113f9f73	last=1053636ddd9
	...
	19873 mempressure-29+knots					ffaa26bd736	last=5b43cc77824 mempressure
	...
	g291  gui_trafficgraph_vert-0.21			e4899a3e0f9	last=500841e49d6  # Enlarge Network Traffic Graph
		# WAS gui#90
	...
	20391 rpc_setfeerate-28+knots				68e2f9c26c5	last=1002e2d0d7f jonatack/setfeerate
	...
	20702 rpc_getblocklocations					98a54a207d1	last=9b03c654eb3
	...
	g363  qt_peers_directionarrow-25+knots		07c03749ef2	last=727a2f83cca qt_peers_directionarrow
	...
	21928 rpc_hww_toggle-25						2499614556c	last=1af20831806 Sjors/2021/05/hww-toggle
	...
	# TODO: 21283 achow101/psbt2
		# TODO: diff-minimise??
	21260 rpcwallet_tx_in_mempool-29+knots		010402ab552	last=46bf0b7b5d8
	...
	22072 autoreindex-29+knots					f06771cf5a9	last=602f4da9178
	...
	g307  gui_peers_rowcolouropt				03614e26ec1	last=fdf80937d1c hebasto-g/210501-stripes
	...
	22372 multinotify							2cf415dc432
	24963 rpc_walletprocesspsbt_options-26		5f3b6a56d44	last=40143bafb52 rpc_walletprocesspsbt_options
	...
	-     rpc_descriptorprocesspsbt_opts		9c5e0df8f8e
	...
	23362 importfromcoldcard					8e54e934791	last=8076f8d4c2a hebasto/211025-cc
	...
	23387 rpc_savefeeestimates-29+knots			ad36b9f24c1	last=d5b41e6b2ed greenaddress/dump_fee_estimates  # savefeeestimates
	...
	g473  rebroad-g/NonLinearTraffic			a5a601b1a9c	last=ad431ff5d18
		# TODO? change to logarithmic scale? 8398d247f4e
	# Needs work: g484 rebroad-g/RetainNetworkGraphOnIntervalChange
	g492  qt_traffic_tooltip					b3c56693bd9	last=6c139ebf710 rebroad-g/NetworkGraphTooltip
	...
	-     verifymsg_bip137_and_electrum			5bf34369780
		# NOTE: Fully reverts gui#819 in anticipation of #24058
	24058 bip322-29+knots						57a00c2989b	last=29b28d07fa9 kallewoof/202201-bip322
	...
	24162 rpc_deriveaddr_wo_checksum-29			bacf986325c	last=97a69e232be
		# +RPC doc fix
	...
	-     whitelist_outgoing_auto				f0f8f61c265
	# Needs work: 26441 brunoerg/2022-10-whitelist-rpc
		# CAUTION: neutrino whitelisting interaction
	27446 benthecarman/configure-signet-blockitme	863a853747e	last=d8434da3c14
	...
	26576 rpc_disconnectnode_subnet				f483b3e1ef4	last=23f4c2cb452 brunoerg/2022-11-disconnectnode-subnet
	...
	27600 p2p_forceinbound-28+knots				0f4f9156c42	last=8c2026848da pinheadmz/whitebind-evict
	...
	27770 rpc_getblockfileinfo-28+knots			ff9e813f194	last=5090771f326 furszy/2023_rpc_getblockfileinfo
	...
	-     manpages_seealso_notself				a0b9b96dc8b
	...
	31560 rpc_dumptxoutset_fifo-29+knots		ab9683b333a	last=b19caeea098 theStack/202412-dumptxoutset-allow_write_to_named_pipe
	...
	32200 socks_tor_error_codes-0.18			0dde0e50338
	# Needs work? 32297 ryanofsky/pr/ipc-cli
	32423 hash_rpcuserpass-29+knots				e1645b2a380	last=e49a7274a21 laanwj/2025-05-remove-rpcpassword-deprecation
		# Left out refactoring
	32425 proxy_per_net-29						e7c4e8c6dfd	last=e98c51fcce9 vasild/proxy_per_network
		# Left out doc updates/reformatting
	32429 doc_rpc_keypoolrefill_pr32429-23		ca962acf9ad
	...
	32540 rest_spenttxouts-26					e7ca5863cd0
		# +32842
	...
	32844 rpc_gettxoutproof_segwit-27+knots		fba04904c33	last=23edd3db4f1 rpc_gettxoutproof_segwit
	...
	33004 def_natpmp_true-29					6e485bbbbe9
	...
	33230 rpc_cli_hashorheight-29				22c8adbccf9	last=df67bb6fd84 achow101/cli-strong-or-json
...
# Non-progress functionality:
	8751  sort-multisigs-28+knots				d096e54f049	last=e11cb50a09  # multisig sorting
	...
	-    ionice_win-29+knots					fd8dbafe48b
	8501  old_stats_rpc-29						da101c6ba63	last=7af0ea43b2
		# Many fixes (incl knots#226)
		# Held back on old version due to conflict with GUI updates...
	8550  old_stats_qt-29+knots					721549ab412	last=63fb11652f
		# Held back on old version due to conflict with RPC updates...
	9504  rpc_dumpmasterprivkey					b3175cdab29	last=07fc81109a
	g444  gui_netwatch-29+knots					bb7e3fb8fb0	 # Latest code now
		# NOTE: Was #9849
		# NOTE: Includes #25050
	10615 multiwallet_rpc-29+knots				bc1eec2ea23  # latest code now
	...
	10350 filtered_witblock-28				1aabb58f46c	last=3f388ddcd3 CodeShark/MFWB_no_bump_2
	...
	11750 coincontrol_multiselect				9da80424189	last=7cec76f81b # Multiselect in coincontrol treewidget and display selected count
		# NOTE: deviated from PR
	11770 rest_fee								272dcc56fb3	last=eff1b3e201  # [REST] add a rest endpoint for estimatesmartfee, docs, and test
	...
	11803 bugfix_dumpwallet_hdkeypath			99563e4ef45
	12965 scriptthreads-29+knots				2634aa558cb	last=dfab6c6866 jonasschnelli/2018/04/svt
	13203 dsha256_power8-29						58e98070079	last=3b402e0738 TheBlueMatt/2018-05-asm
		# NOTE: Stripped out benchmark change
		#29.xTODO# Watch for Makefile.am or other changes for shared libbitcoinkernel on Windows
	15218 postibd_flush-28						574cd728bed	last=8887d28a014  andrewtoth/flush-after-ibd
	15428 tor_gui_pairing-29+knots				dca1be8f967	last=ab9ed21dc98 tor_gui_pairing-0.21+knots
		# Implicitly relies on gui#506 for QR Code without text being centred (dropped buggy 4a881554991)
	15421 tor_subprocess-29+knots				b68cc3aeead	# Latest code now
	...
	17795 gui_console_ctrl_d-26+knots			dd969efb050
		# NOTE: Completely rewrote to work on all platforms, in addition to Ctrl-W
	15861 restore_vbits_warning					f05db3c804d
	n/a   rpc_compat_error_index-25+knots		79d1bf0fb7b
		# Compatibility with 0.19.0-0.21.0 bech32_error_detection
	g537  gui_bech32_errpos						c48e5e5300b
	17636 guisettings-0.21						8c1a4319110	last=187f9684e03 emilengler/2019-11-guisettings
		# Held back 5266efa964b..187f9684e03 (too strict error checking?)
		# (and removed release notes)
	17958 rpc_getgeneralinfo					2ad63c7bb11	last=cdbd38df131  # getgeneralinfo RPC
	18223 blockfilter_v0						23172b71240	last=5561e7a0c79
		# NOTE: Don't enable with -blockfilterindex=1
		# NOTE: Diff-minimised
	19089 cli_getinfo_mwbalances-29				c816c75ee85	last=865d2c32d5a jonatack/cli-getinfo-multiwallet-follow-ups
	19092 cli_getinfo_mw_total_balance-29+knots	ceddde9fe4d	last=08ac1abc583 jonatack/cli-getinfo-multiwallet-total-balance
	(CHECK-LAST)	last=71bfa1fb715 cli_getinfo_mw_total_balance-26
	19117 rpc_getrpcwhitelist					fa4a150a7b7
		# NOTE: Was #18827 before any Knots merge
	-     getrpcwhitelist_wallets-29+knots		ee692372b8c
		# NOTE: when #19118..#19120 get merged, add 71294ee9799
	# Needs purpose: 21815 prayank23:max-out-full-relay
	-     wallettool_dump_warning-29+knots		84e0b44122f
...
m	-     restore_upnp-29.3+knots				04768be5791
	...
	n/a   restore_feefilter_opt					7f370a9d258
	-     gui_payreq_textedit					4f51bc8f4c0
...
NM	14137 win_taskbar_progress					5ec83bf006e	last=18eb4dbb8a
	...
	11082 rwconf-29+knots						0565ad79074 # Latest code now
		#30.xTODO# Squash fixes
		#30.xTODO# Deprecate with settings.json better?
	7510  rwconf_gui-29.1+knots					704d76d29f0
		#30.xTODO# Squash fixes
	...
	929   tbc									648ac3fc0ac
	n/a   tbc_font								ccc9d1fce50
		# Includes ff7b90dc729 Embedded font: Rename to avoid confusion in font selector  (fix_qt_fontsel_confusion)
	 553 bugfix_qt_uri_amount_parser			d01e4ef17ab
	5861 gui_restore_addresses					bbf18f383df
	...
	-     gui_wallet_displayname_wo_dat			6d07e877168	# Latest code now
	-     gui_request_payment_label-0.19		2507b46d76b
	-     gui_peers_sort_network-23				3fdaf88611c
	-     gui_peers_no_net_column				42d7f536329
	...
	-     rpc_getblockfrompeer_future			bbf77c7b744
		# Revert of #23927
	-     rpc_getblockfrompeer_wo_header		fddc6b3433d
	...
	32547 mining_avoid_block_copy-29+knots		2b1ea8ccc02	last=7d05ec01d4e mining_avoid_block_copy
	-     gbt_rpc_options-29+knots				ed4adbacbd3
	...
	-     blockview-29+knots					25fe39b0a1e
	...
	-     restore_libconsensus					e52a2c7a8cc
	...
	-     rpccookieperms_log_improvements-29+k	70e61a0d976
	...
	33023 qa_cb_extratxs-25						3c44e70bb5e	last=841b3c2e966 bigshiny90/compactblocks-extratxs-tests-core
		# Held back f9c6331cb26...841b3c2e966 for now
	#30.xTODO# Revert #32450 ?
	#30.xTODO# Revert #32510 or replace extratxn pool
	k171  Raimo33/add-dockerfile				9d0ac5db322	last=4b778a21835
	k187  Retropex/dnsseed-leo					0e3f1949dc2	last=68abc8a3262
...
# Non-upstreamed policy options (default off):
	...
	-     mining_priority						efaa93c383a	# Latest code now
...
m	7219  rbf_opts-29+knots						1f726c1879c	# Latest code now
	...
	-     bytespersigopstrict-29+knots			fac10330161
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	9749  unique_spk_mempool-29.2+knots			59947bf1b89
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	-     dustdynamic-29.1+knots				b6a073281d1
	# ---- BEGIN DATACARRIER ---- (OLGA not backported)
	28408 match_more_datacarrier-29+knots		ac50adee244	last=4d2ec0671a3 match_more_datacarrier
...
m	-     acceptnonstddatacarrier-29+knots		22fd60450d3
	...
	# ---- END DATACARRIER ----
	k136  pol_permitephemeral					70752d17e2a
	...
	-     rejecttokens-29.1+knots				d95de1ed0ee
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		# Currently filters just Runes
	k78   rejectparasites-29.1+knots			824f0776af3	last=d978324923a
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	...
	-     maxscriptsize-29+knots				c398bc7be1a
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		# Alternate to(?) #29769
	...
	k148  minrelaymaturity-29.1+knots			28966e9a09f
...
# Non-upstreamed Knots compatibility:
	...
	-     compat_rpc_dumptxoutset_hr			f05af4c2e07
		# FIXME: 'type' param attempts to parse as JSON ? (with 28.x bitcoin-cli tho)
		# FIXME: 'rollback' param rejects height ?
	-     compat_jsonrpc_weirdversions			3fc6e41d51c
	29530 rpc_getpeerinfo_misbehaving_score-29+k	d1bd48939b7	last=87efb6f0cfd
	...
	-     rpccookieperms_octal_compat-29+knots	c79acb56624
	-     zmq_ipc_uri_compat					3482d037c4b	last=0b1762c90d1 origin-pull/28020/head
	...
	-     wallet_undeprecate_legacy-29			2fa20cdd9e3
	...
	14641 fundraw_min_conf_deprecated-25+knots	3a527b74e47	last=55a0b4c0f90 promag/2018-11-fundrawtransaction
	-    preserve_unsupported_keyflags			79653aa6762
	-     netperms_implicit_addr				942d31d3bc1
	-     rpc_getblockfrompeer_nodeid_compat	cdcba9c0ec0
	# TODO: add a bitcoinknots.conf ?
	n/a   gui_peers_bump_setting_keys-29+k		eb80fda3664
...
# POLICY:
	-    1day_default_conftarget				0551ec34292
	...
	-     def_bloom_local_only					0c2ecbb1543
		# NOTE: Includes typo fix
	-     wallet_avoid_newerchange				ab7ae947497
...
# TODO: test fuzzer with everything enabled
	...
	n/a  (bump_version=knots20260717.lts)		c9c7b75b7e7
		# Spec-way assembly verified: knots-29.3.knots20260717.lts.spec via
		# assemble-knots.pl reproduces tree 670aca2d74f, identical to this branch
		# (branch 29.x-knots-lts.spec-assembled)
		# Baseline was bump_version=knots20260508 (931ea36c899); for each LTS
		# point release, replace with bump_version=knots<YYYYMMDD>.lts
#	n/a  knots_historical_relnotes				61100a2
	n/a   rm_historical_relnotes_from_dist		06757b4cabe
	n/a   (cherrypick=0b04ddc31b7)				dce09dbcdc4  # release notes: write/update, including change log and credits
	...
	n/a  (cherrypick=f41f01e1e6d)				a9aee730466  # update manpages (build first)
